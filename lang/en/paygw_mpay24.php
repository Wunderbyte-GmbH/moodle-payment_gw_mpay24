...
$string['brandname_help'] = 'An optional label that overrides the business name for the mpay24 account on the mpay24 site.';
$string['cannotfetchorderdetails'] = 'Could not fetch payment details from mpay24. Your account has not been debited.';
...
$string['privacy:metadata'] = 'The mpay24 plugin does not store any personal data.';
